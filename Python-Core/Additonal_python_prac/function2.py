...
### Q3Implement memoized Fibonacci using functions.
### Q4Write a function that validates a password using multiple rules.
### Q5Build a mini calculator using functions.
### Q6Write a function that merges overlapping intervals.
### Q7Write a function that rotates a list by `k` positions.
...
### Q13Calculate overtime pay if working hours exceed 40.
### Q14Return free shipping if the order amount exceeds a threshold.
### Q15 Determine whether a student passes based on minimum marks criteria.